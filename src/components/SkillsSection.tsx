...
export default function SkillsSection() {
    ...
    return (
        <div className="min-h-screen w-full py-16 px-6 flex flex-col items-center justify-center gap-8 bg-linear-to-b from-background to-background via-accent/40" id="skills">
